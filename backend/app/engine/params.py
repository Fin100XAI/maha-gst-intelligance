...
DEFAULT_PARAMETERS: Final[tuple[ParameterRow, ...]] = (
    ...
    _p(
        ...
        "5",
        unit="units",
        note="docs/01 section 7: quantity <= 5 against a value above Rs 1 crore",
    ),
    _p("X-08", "min_value", "10000000", unit="INR", note="docs/01 section 7: value > Rs 1 crore"),
    _p("X-10", "min_delta", "100000", unit="INR", note="docs/01 section 7: delta > Rs 1 L"),
