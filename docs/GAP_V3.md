...
| 6b | A–L checks built | 3 | **Built.** Reproduces `docs/07` Finding 2 exactly: Rs 95,79,967.02 on B2B, 29 suppliers, SSR Shipyard Rs 77,99,266.80. Needed migration 0006 for `supplier_3b_filed`. **`B-08` duplicate ITC** added: `CLEAR` on the reference workbook, where a naive implementation reports 4,636 false duplicates out of 9,450 rows (D-0096) |
