...
| 6 | `X-01`–`X-12` self-contradiction | 3 | **Eight of twelve built**: X-01 to X-06, X-11, X-12. X-01 reproduces `docs/07` Finding 1 to the paisa; X-03/X-04 are ASSISTED; X-05 is X-01's complement by construction; X-12 became possible once sections resolved and the amended-document reference was mapped (D-0091, D-0092). X-07/08/09/10 need HSN, quantity, Table 13 or GSTR-7 — none ingested |
